...
export default function HomePage() {
  ...
  // Login form fields (controlled to avoid uncontrolled->controlled warnings)
  ...
  function handleLogin(e: React.FormEvent) {
    ...
    window.location.href =
      ...
      encodeURIComponent("/auth/continue");
  }
  ...
  return (
    <div className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/f7406f97-a24a-4705-be21-6aa0c9a088fd.jpg')",
        }}
      />
        ...
        <div className="flex-1 text-white space-y-6">
          <div>
            ...
            <p className="mt-3 text-blue-100 text-lg max-w-md">
              Isang komunidad na nagkakaisa para sa trabaho at kabuhayan ng
              bawat mamamayan.
            </p>
          </div>

          <blockquote className="border-l-4 border-blue-300 pl-4 text-blue-100 italic text-base max-w-sm">
            "Ang bawat residente ng Barangay 634 ay may karapatang magkaroon ng
            maayos na kabuhayan. Sama-sama tayo sa pag-unlad."
          </blockquote>
        ...
        <div className="w-full max-w-sm bg-white rounded-2xl shadow-2xl p-8">
          ...
          {tab === "login" ? (
            ...
            <form onSubmit={handleSignup} className="space-y-4">
              <div>
                <label className="block text-xs font-medium text-gray-600 mb-1">
                  Role Keyword (applicant/employer)
                </label>
